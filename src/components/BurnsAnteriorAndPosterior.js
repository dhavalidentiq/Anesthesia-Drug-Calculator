...
// type BurnsAnteriorAndPosterior = {
//   textColor: string,
//   peds: boolean,
//   frontBodyParts: any,
//   pediatricBodyParts: any,
//   hoursAgo: any,
//   result: any,
//   isFrontSide: boolean,
//   isObesePatient: boolean,
//   hoursvalue: (val: any) => void,
//   _adultOnValueChange: (val: any) => void,
//   _pediatricOnValueChange: (val: any) => void,
//   _selectFrontBodyParts: (val: any) => void,
//   _pediatricSelectBodyParts: (val: any) => void,
// };
        ...
        <View style={{ alignItems: 'center' }}>
          <Text>
            <Text
              ...
              numberOfLines={1}
              adjustsFontSizeToFit>{`1st rate:`}</Text>
            <Text
              style={{
              ...
              numberOfLines={1}
              adjustsFontSizeToFit>{` ${Math.round(
              result.fluidInFirst8Hours,
            )} ml/hr`}</Text>
        ...
        <View style={{ alignItems: 'center' }}>
          <Text>
            <Text
              ...
              numberOfLines={1}
              adjustsFontSizeToFit>{`2nd rate:`}</Text>
            <Text
              style={{
                fontSize: responsiveScale(17),
                fontFamily: font.outfit_Regular,
            ...
            <View
              ...
              <View style={styles.percentageMainView}>
                <Text style={styles.percentageNumberText}>
                  {hoursAgo}{' '}
                  <Text style={styles.percentageNumberText}>hrs</Text>
                </Text>
              </View>
            </View>
          )}
